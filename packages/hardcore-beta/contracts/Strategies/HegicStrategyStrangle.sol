...
contract HegicStrategyStrangle is HegicStrategy {
        ...
        returns (uint256 amount)
    {
        ...
        uint256 callStrike = ((data.strike * (100 + strikePercentage)) / 100)
            .round(roundedDecimals);
        uint256 putStrike = ((data.strike * (100 - strikePercentage)) / 100)
            .round(roundedDecimals);
    ...
    function buy(
        ...
        uint256 callStrike = ((strike * (100 + strikePercentage)) / 100).round(
            roundedDecimals
        );
        uint256 putStrike = ((strike * (100 - strikePercentage)) / 100).round(
            roundedDecimals
        );
